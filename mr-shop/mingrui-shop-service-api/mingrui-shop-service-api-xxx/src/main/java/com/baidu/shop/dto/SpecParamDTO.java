...
public class SpecParamDTO {
    ...
    @NotNull(message = "是否 是 数字类型参数不能为空",groups = {MingruiOperation.add.class,MingruiOperation.Update.class})
    ...
    @NotNull(message = "是否是sku通用屬性不能为空",groups = {MingruiOperation.add.class,MingruiOperation.Update.class})
    private Boolean generic;

    @ApiModelProperty(value = "是否用于搜索过滤，1->true或0->false",example = "0")
    @NotNull(message = "是否用来搜索过滤不能为空",groups = {MingruiOperation.add.class,MingruiOperation.Update.class})
